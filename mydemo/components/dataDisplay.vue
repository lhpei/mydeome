<template>
  <div>
    <!-- 搜索设备 -->
    <div class="sousuo123" style="z-index: 5;">
      <div style="margin-left: 1rem;margin-top:1rem">
        <el-input placeholder="请输入设备名称"></el-input>
      </div>
      <div style="margin-left: 1rem;margin-top:1rem">
        <el-button type="primary">查找设备</el-button>
      </div>
    </div>
    <!-- 高德地图 -->
    <div style="width: 87rem;height: 38rem;z-index: -1;">
      <Mymap></Mymap>
    </div>
  </div>
...
<!-- <template>
  ...
  <div class="fl mapDiv">
    <div class="mapCon">
      ...
      <div id="main" class="mapChart" style="width:40rem;height:40rem;"></div>
    </div>
  </div>
</template> -->
